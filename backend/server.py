...
class EventRequest(BaseModel):
    user_id: str
    event_type: str  # "king", "king_1", "king_3", "cp_6", "cp_7"

@api_router.post("/events/request")
...
@api_router.get("/events/requests")
...
@api_router.post("/events/approve/{request_id}")
...
@api_router.post("/events/reject/{request_id}")
...
@api_router.get("/events/my-events/{user_id}")
...
@api_router.post("/events/update-progress")
...
@api_router.post("/events/cp-levelup")
...
@api_router.post("/games/pk-battle")
...
@api_router.get("/games/pk-battle/{room_id}")
...
@api_router.post("/games/pk-battle/{battle_id}/gift")
...
@api_router.post("/games/pk-battle/{battle_id}/end")
